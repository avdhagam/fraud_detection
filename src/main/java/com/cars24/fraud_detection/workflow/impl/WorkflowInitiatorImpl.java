...
//
//@Slf4j
//@Component("workflowInitiatorImpl")
...
//        try {
//            // Run OCR Extraction
//            String ocrOutput = pythonExecutor.runPythonScript("DocumentOcr.py", documentPath).toString();
...
//                    .documentId(null)  // or some valid ID
//                    .isValid(true)
//                    .finalRiskScore(85.5)  // Example score
//                    .riskLevel("High")
//                    .decision("Approve")
//                    .nextSteps("Proceed with verification")
//                    .remarks("Verified successfully")
//                    .ocrResults(new HashMap<>()) // Example empty map
//                    .qualityResults(new HashMap<>())
//                    .forgeryResults(new HashMap<>())
