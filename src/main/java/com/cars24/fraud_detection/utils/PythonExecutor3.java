...
public class PythonExecutor3 {
    ...
    /**
     * Alternative method that always returns the raw output as a string in the result map,
     * without attempting to parse it as JSON.
     */
    public Map<String, Object> runPythonScriptRaw(String scriptName, Object... args) {
        try {
            // Use platform-independent Python command
            String pythonCommand = System.getProperty("os.name").toLowerCase().contains("win") ? "python" : "python3";
